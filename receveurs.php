...
if (isset($_GET['page'])) {
    ...
    if ($page == 'add') {
        ...
        $sql = "DELETE FROM receveur WHERE id = $id";
        mysqli_query($db, $sql);
        // recharger la page
        header('location: receveurs.php');
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <h2 class="heading-section">Tableau des receveurs</h2>
                </div>
            </div>
                            ...
                            <tbody>
                                <?php while ($ligne = mysqli_fetch_row($result)) { ?>
                                    <tr>
                                        ...
                                        <td> <a href="updaterec.php?page=update&id=<?php echo $ligne[3]; ?>" class="btn btn-success">modifier</a></td>
