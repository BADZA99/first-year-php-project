...
<body>
    ...
    $id = $_GET['id'];
    //echo $id;
    $requete = "SELECT * FROM receveur WHERE id=$id";
    ...
    if (isset($_POST['save'])) {
        ...
        $age = $_POST['age'];
        //var_dump($_POST);
        $sql = "UPDATE `receveur` SET  `nom`='$nom',`prenom`='$prenom',`telephone`='$phone',`age`='$age' WHERE id=$id";
        // var_dump($sql);
            ...
            <div class="card card-3">
                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        ...
                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="Phone" name="phone" id="phone" value=<?= $ligne[2] ?>>
                        </div>

                        <div class="input-group">
                            <input class="input--style-3" type="text" placeholder="age" name="age" id="age" value=<?= $ligne[4] ?>>
                        </div>
