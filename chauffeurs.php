...
<body>
    ...
    <!-- PHP POUR RECUPERER LES DONNES DE LA BDD ET LE LISTER MODIFIER SUPPRIMER -->
    <?php
    $db = mysqli_connect('localhost', 'root', '', 'projetexamen');
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <h2 class="heading-section">Tableau des chauffeurs</h2>
                </div>
            </div>
                            ...
                            <tbody>
                                <?php while ($ligne = mysqli_fetch_row($result)) { ?>
                                    <tr>
                                        ...
                                        <td> <a href="updateChauff.php?page=update&id=<?php echo $ligne[3]; ?>" class="btn btn-success">modifier</a></td>
                                        <td> <a href="?page=delete&id=<?php echo $ligne[3]; ?>" class="btn btn-danger">supprimer</a></td>
